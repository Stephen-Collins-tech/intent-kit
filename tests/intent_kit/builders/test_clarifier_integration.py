...
class TestClarifierIntegration:
    ...
    def test_graph_builder_with_clarifier_node(self):
        ...
        assert clarifier_node.clarification_prompt == "Please provide more details about your booking request: {input}"
        assert clarifier_node.expected_response_format == "Please specify: [type] [date] [time] [destination]"
    ...
    def test_graph_builder_validation_missing_clarification_prompt(self):
        ...
        assert len(validation_result["errors"]) > 0
        assert any("missing 'clarification_prompt' field" in error for error in validation_result["errors"])
    ...
    def test_intent_graph_with_clarifier_node(self):
        ...
        with patch('intent_kit.graph.intent_graph.classify_intent_chunk') as mock_classify:
            ...
            assert "Please provide more details about your booking: book something" in clarifier_result.output["clarification_message"]
    ...
    def test_clarifier_node_with_context_integration(self):
        ...
        result = clarifier_node.execute("ambiguous input", context=context)
        ...
        response = clarifier_node.handle_clarification_response("clarified input", context)
    ...
    def test_clarifier_node_max_attempts_integration(self):
        ...
        response = clarifier_node.handle_clarification_response("another attempt", context)
    ...
    def test_clarifier_node_placeholder_replacement_integration(self):
        ...
        expected_message = "Your input 'book flight' needs clarification. Please provide more details."
