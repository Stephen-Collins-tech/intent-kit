...
class TestNodeType:
    ...
    def test_def test_def test_unknown_node_type(self): -> None: -> None:
        """Test the UNKNOWN node type."""
        assert NodeType.UNKNOWN.value == "unknown"

    def test_def test_def test_action_node_type(self): -> None: -> None:
        """Test the ACTION node type."""
        assert NodeType.ACTION.value == "action"

    def test_def test_def test_classifier_node_type(self): -> None: -> None:
        """Test the CLASSIFIER node type."""
        assert NodeType.CLASSIFIER.value == "classifier"

    def test_def test_def test_splitter_node_type(self): -> None: -> None:
        """Test the SPLITTER node type."""
        assert NodeType.SPLITTER.value == "splitter"

    def test_def test_def test_clarify_node_type(self): -> None: -> None:
        """Test the CLARIFY node type."""
        assert NodeType.CLARIFY.value == "clarify"

    def test_def test_def test_graph_node_type(self): -> None: -> None:
        """Test the GRAPH node type."""
        assert NodeType.GRAPH.value == "graph"

    def test_def test_def test_unhandled_chunk_node_type(self): -> None: -> None:
    ...
    def test_def test_def test_enum_comment_documentation(self): -> None: -> None:
