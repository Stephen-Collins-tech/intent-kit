...
class TestClarifierNode:
    ...
    def test_clarifier_node_execute_basic(self):
        ...
        assert "Please provide more details about book something" in result.output["clarification_message"]
    ...
    def test_clarifier_node_with_placeholder_replacement(self):
        ...
        expected_message = "Your input 'book flight' is unclear. Please provide more details."
    ...
    def test_clarifier_node_without_placeholder(self):
        ...
        assert result.output["clarification_message"] == "Please provide more information."
    ...
    def test_clarifier_node_path_and_uuid(self):
        ...
        parent = ClarifierNode(
            name="parent",
            clarification_prompt="Parent prompt"
        )
        
        child = ClarifierNode(
            name="child",
            clarification_prompt="Child prompt",
            parent=parent
        )
