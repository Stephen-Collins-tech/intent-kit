...
class TestDeclareDependencies:
    ...
    def test_declare_dependencies_basic(self):
    ...
    def test_declare_dependencies_empty(self):
    ...
    def test_declare_dependencies_no_description(self):
...
class TestValidateContextDependencies:
    ...
    def test_validate_dependencies_strict_mode(self):
    ...
    def test_validate_dependencies_no_inputs(self):
    ...
    def test_validate_dependencies_empty_context(self):
...
class TestMergeDependencies:
    ...
    def test_merge_dependencies_outputs_removed_from_inputs(self):
    ...
    def test_merge_dependencies_single(self):
    ...
    def test_merge_dependencies_no_descriptions(self):
...
class TestAnalyzeActionDependencies:
    ...
    def test_analyze_action_dependencies_not_callable(self):
        """Test analysis of non-callable object."""
        result = analyze_action_dependencies("not_callable")
        
        assert result is None

    def test_analyze_action_dependencies_with_explicit_deps(self):
    ...
    def test_analyze_action_dependencies_with_annotations(self):
    ...
    def test_analyze_action_dependencies_with_docstring(self):
...
class TestCreateDependencyGraph:
    ...
    def test_create_dependency_graph_no_dependencies(self):
    ...
    def test_create_dependency_graph_circular(self):
    ...
    def test_create_dependency_graph_single_node(self):
...
class TestDetectCircularDependencies:
    ...
    def test_detect_circular_dependencies_self_loop(self):
    ...
    def test_detect_circular_dependencies_single_node(self):
...
class TestContextAwareAction:
    ...
    def test_context_aware_action_protocol(self):
...
class TestIntegration:
    ...
    def test_circular_dependency_workflow(self):
