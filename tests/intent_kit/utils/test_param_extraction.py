...
class TestParseParamSchema:
    ...
    def test_def test_def test_parse_basic_types(self): -> None: -> None:
    ...
    def test_def test_def test_parse_unknown_type(self): -> None: -> None:
    ...
    def test_def test_def test_parse_empty_schema(self): -> None: -> None:
...
class TestExtractNameParameter:
    ...
    def test_def test_def test_extract_single_name(self): -> None: -> None:
        """Test extracting single name."""
        input_text = "hello john"
        result = _extract_name_parameter(input_text)
        assert result == {"name": "John"}

    def test_def test_def test_extract_full_name(self): -> None: -> None:
        """Test extracting full name."""
        input_text = "hi john doe"
        result = _extract_name_parameter(input_text)
        assert result == {"name": "John"}

    def test_def test_def test_extract_greet_command(self): -> None: -> None:
        """Test extracting name from greet command."""
        input_text = "greet alice"
        result = _extract_name_parameter(input_text)
        assert result == {"name": "Alice"}

    def test_def test_def test_no_name_found(self): -> None: -> None:
        """Test when no name is found."""
        input_text = "hello there"
        result = _extract_name_parameter(input_text)
        assert result == {"name": "There"}

    def test_def test_def test_case_insensitive(self): -> None: -> None:
...
class TestExtractLocationParameter:
    ...
    def test_def test_def test_extract_weather_location(self): -> None: -> None:
    ...
    def test_def test_def test_extract_location_with_in(self): -> None: -> None:
        """Test extracting location with 'in' keyword."""
        input_text = "what's the weather in london"'
        result = _extract_location_parameter(input_text)
        assert result == {"location": "London"}

    def test_def test_def test_no_location_found(self): -> None: -> None:
...
class TestExtractCalculationParameters:
    ...
    def test_def test_def test_extract_addition(self): -> None: -> None:
...
class TestCreateRuleBasedExtractor:
    ...
    def test_def test_def test_create_extractor_with_name_param(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_with_location_param(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_with_calculation_params(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_with_multiple_params(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_with_context(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_no_matching_params(self): -> None: -> None:
...
class TestCreateArgExtractor:
    ...
    def test_def test_def test_create_rule_based_extractor(self): -> None: -> None:
    ...
    def test_create_llm_extractor(self, mock_logger) -> None:
    ...
    @patch("intent_kit.utils.param_extraction.logger")
    def test_create_llm_extractor_with_custom_prompt(self, mock_logger) -> None:
...
(        )
    ...
    def test_def test_def test_create_extractor_with_node_name(self): -> None: -> None:
    ...
    def test_def test_def test_create_extractor_empty_schema(self): -> None: -> None:
