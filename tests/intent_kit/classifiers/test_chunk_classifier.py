...
class TestCreateClassificationPrompt:
    ...
    def test_create_classification_prompt_with_special_characters(self):
        ...
        prompt = _create_classification_prompt("Book a flight with 'quotes' and \"double quotes\"")
...
class TestManualParseClassification:
    ...
    def test_manual_parse_atomic_keywords(self):
        ...
        result = _manual_parse_classification("This is an atomic single intent", "Book a flight")
    ...
    def test_manual_parse_composite_keywords(self):
        ...
        result = _manual_parse_classification("This is a composite split intent", "Book a flight")
    ...
    def test_manual_parse_ambiguous_keywords(self):
        ...
        result = _manual_parse_classification("This is an ambiguous clarify intent", "Book a flight")
    ...
    def test_manual_parse_no_keywords(self):
        ...
        result = _manual_parse_classification("Random text without keywords", "Book a flight")
