...
class ClarifierNode(TreeNode):
    ...
    def handle_clarification_response(
        ...
        if clarification_context:
            ...
            if clarification_context["attempts"] >= clarification_context["max_attempts"]:
                return {
                    "success": False,
        ...
        return {
            ...
            "original_input": clarification_context["original_input"] if clarification_context else user_input,
            "attempts": clarification_context["attempts"] if clarification_context else 1,
        }