...
class NodeExecutionError(NodeError):
    ...
    def __init__(self, node_name: str, taxonomy_name: str, error_message: str, params=None, node_id: Optional[str] = None, node_path: Optional[List[str]] = None):
        """
        Initialize the exception.

        Args:
            node_name: The name of the node that failed
            taxonomy_name: The name of the taxonomy containing the node
        ...
        message = f"Node '{node_name}' in taxonomy '{taxonomy_name}' failed: {error_message}"
...
class NodeInputValidationError(NodeValidationError):
    ...
    def __init__(self, node_name: str, taxonomy_name: str, validation_error: str, input_data=None, node_id: Optional[str] = None, node_path: Optional[List[str]] = None):
        """
        Initialize the exception.
        ...
        message = f"Node '{node_name}' in taxonomy '{taxonomy_name}' input validation failed: {validation_error}"
        super().__init__(message)
...
class NodeOutputValidationError(NodeValidationError):
    ...
    def __init__(self, node_name: str, taxonomy_name: str, validation_error: str, output_data=None, node_id: Optional[str] = None, node_path: Optional[List[str]] = None):
        """
        Initialize the exception.
        ...
        message = f"Node '{node_name}' in taxonomy '{taxonomy_name}' output validation failed: {validation_error}"
        super().__init__(message)
...
class NodeNotFoundError(NodeError):
    ...
    def __init__(self, node_name: str, taxonomy_name: str, available_nodes=None):
        """
        Initialize the exception.

        Args:
            node_name: The name of the node that was not found
            taxonomy_name: The name of the taxonomy where the node was searched
            available_nodes: List of available node names in the taxonomy
        """
        self.node_name = node_name
        self.taxonomy_name = taxonomy_name
        self.available_nodes = available_nodes or []

        message = f"Node '{node_name}' not found in taxonomy '{taxonomy_name}'"
        super().__init__(message)
...
class NodeArgumentExtractionError(NodeError):
    ...
    def __init__(self, node_name: str, taxonomy_name: str, error_message: str, user_input=None):
        """
        Initialize the exception.
        ...
        message = f"Node '{node_name}' in taxonomy '{taxonomy_name}' argument extraction failed: {error_message}"
        super().__init__(message)
